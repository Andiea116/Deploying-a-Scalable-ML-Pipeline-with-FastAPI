...
async def get_root():
    """ Say hello!"""
    return {"Message": "You've successfully connected. Welcome to API!"}
...
async def post_inference(data: Data):
    ...
    # Process Data to determine the salary threshold. 
    ...
    return {"Results": apply_label(_inference)}
